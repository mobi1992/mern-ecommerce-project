                    ...
                    <Row>
                        ...
                        <Col lg='4' md='5'>
                            ...
                            <Row>
                                ...
                                <Col>
                                    <p className='text-end responsive-content-cart-button'>Rs {getCartItemsUnknownUser.cart.totalPrice}</p>
                                </Col>
                            </Row>
                            <div className='mb-2 d-grid gap-2'>
                                ...
                                <Button onClick={() => navigate(routePaths.mainCartUnk)} size='lg' className='cart-btn responsive-content-cart-button'>View The Cart</Button>
