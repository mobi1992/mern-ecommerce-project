...
const AllProducts = () => {
    ...
    window.onpopstate = function (event) {
        if (event) {
            ...
            if (sortBy === 'price_asc')
            {localStorage.setItem('AllProductsValue', 'Price, low to high')}
            else if (sortBy === 'price_desc')
            {localStorage.setItem('AllProductsValue', 'Price, high to low')}
            else if (sortBy === 'createdAt_asc')
            {localStorage.setItem('AllProductsValue', 'Date, Old to New')}
            else if (sortBy === 'createdAt_desc')
            {localStorage.setItem('AllProductsValue', 'Date, New to Old')}
