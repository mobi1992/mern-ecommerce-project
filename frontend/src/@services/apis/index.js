...
export const apis = {
    ...
    updateProfile : async({firstName, lastName, email}) => axios.put('/update/me', {firstName, lastName, email}, { headers: { Authorization: "Bearer " + await localStorage.getItem("AUTH_TOKEN")}}),
    updateAddress : async({country, province, city, address, postalCode, phoneNo}) => axios.put('/address/update', {country, province, city, address, postalCode, phoneNo}, { headers: { Authorization: "Bearer " + await localStorage.getItem("AUTH_TOKEN")}}),
    ...
    loggedinUsrEmptyCart : async () => axios.get('/empty/cart', { headers: { Authorization: "Bearer " + await localStorage.getItem("AUTH_TOKEN")}}),
    ...
    createNewOrderLoggedinUsr : async({shippingInfo, paymentInfo, shippingPrice}) => axios.post('/order/new', {shippingInfo, paymentInfo, shippingPrice}, { headers: { Authorization: "Bearer " + await localStorage.getItem("AUTH_TOKEN")}}),
    ...
    getLoggedinUsrOrders : async() => axios.get('/orders/me', { headers: { Authorization: "Bearer " + await localStorage.getItem("AUTH_TOKEN")}}),
    getLoggedinUsrOrder : async(id) => axios.get(`/order/me/${id}`, { headers: { Authorization: "Bearer " + await localStorage.getItem("AUTH_TOKEN")}})
}